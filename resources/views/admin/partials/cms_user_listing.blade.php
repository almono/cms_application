@foreach($users as $u)
    <div class="col-xs-12 padding_fix text-center" style="color: white; padding-top: 10px; padding-bottom: 10px; @if(!$loop->last) border-bottom: 1px solid #222; @endif">
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-2 padding_fix">
            {{ $u->username }}
        </div>
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-2 padding_fix">
            {{ $u->email }}
        </div>
        <div class="col-xs-6 col-sm-6 col-md-1 col-lg-1 padding_fix">
        ...
        <div class="col-xs-12 col-md-2 col-lg-1 padding_fix hidden-xs hidden-sm">
            <div class="pretty p-default p-thick p-pulse" style="margin-right: -5px;">
